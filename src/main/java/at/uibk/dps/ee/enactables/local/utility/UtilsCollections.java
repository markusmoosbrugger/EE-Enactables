...
public final class UtilsCollections {
   ...
   */
  public static CollOperEIdx readSubCollections(final String inputString,
  ...
  protected static CollOper getSubCollectionForString(final String subcollectionString,
    ...
    if (subcollectionString.contains(ConstantsEEModel.EIdxSeparatorInternal)) {
      // start end stride
      final int numberSeparators =
          subcollectionString.split(ConstantsEEModel.EIdxSeparatorInternal).length - 1;
      if (numberSeparators == 1) {
        final String startString =
            subcollectionString.split(ConstantsEEModel.EIdxSeparatorInternal)[0];
        final String endString =
            subcollectionString.split(ConstantsEEModel.EIdxSeparatorInternal)[1];
        ...
        final String endString =
            subcollectionString.split(ConstantsEEModel.EIdxSeparatorInternal)[1];
        final String strideString =
            subcollectionString.split(ConstantsEEModel.EIdxSeparatorInternal)[2];
        final int start = determineCollOperParam(startString, jsonInput);
        final int end = determineCollOperParam(endString, jsonInput);
   ...
   * @return
   */
  protected static int determineCollOperParam(final String loopParamString,

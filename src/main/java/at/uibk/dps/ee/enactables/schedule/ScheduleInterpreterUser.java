...
public abstract class ScheduleInterpreterUser implements ScheduleInterpreter{
	...
	@Override
	public final EnactmentFunction interpretSchedule(Task task, Set<Mapping<Task, Resource>> scheduleModel) {
	 ...
	 */
	protected abstract EnactmentFunction interpretScheduleUser(Task task, Set<Mapping<Task, Resource>> scheduleModel);
}
